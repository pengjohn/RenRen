...
#ifndef  __RENRENAPI_TEST_H__
#define  __RENRENAPI_TEST_H__

#include "RenRenAPI.h"


class TTestForm : public TWindow
{
public:
	TTestForm(TApplication* pApp);
	virtual ~TTestForm(void);
